...
<html>
  ...
  <body class="grey lighten-1" style="background-color:grey!important;">Diving into the Java language . All the programs are written to get started  with java programming 
    ...
    <pre>Enter Number Range limit <span style="font-size:26px;font-weight:bolder;">&ldsh;</span><br>20 &ldsh;<br>First 20 non-prime numbers are :<br>4 6 8 9 10 12 14 15 16 18 20 21 22 24 25 26 27 28 30 32 
    </pre>
